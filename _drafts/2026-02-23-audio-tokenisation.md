...
- **Hierarchical generation:** semantic codebook autoregressively with the LLM, acoustic codebooks with a smaller non-autoregressive model. AudioLM and VALL-E sit here, SoundStorm generates all codebook levels in parallel through MaskGIT-style iterative masking and infilling, and most production voice-generation systems converge toward something like it.
