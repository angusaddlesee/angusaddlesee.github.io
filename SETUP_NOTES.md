...
Your al-folio website has been configured with your information! Here's what's been updated:
...
- Medium: addlesee
- X/Twitter: Addlesee_AI
- YouTube: UCWT5QO09NnvGkikoQW4aYug
...
1. **Add Your Photo**: Replace `assets/img/prof_pic.jpg` with your professional photo
2. **Update Publications**: Replace the placeholder bibliography with your actual publications
3. **Customize Projects**: Update remaining project files in `_projects/` folder
4. **Add Blog Posts**: Create posts in `_posts/` folder if desired
5. **Deploy**: Push to GitHub and enable GitHub Pages

## 🚀 Deployment

The site is configured for GitHub Pages. When you're ready to use your custom domain:

1. Uncomment and update these lines in `_config.yml`:
   ```yaml
   url: "https://www.addlesee.co.uk"
   baseurl: ""
   ```
